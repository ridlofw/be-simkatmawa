...
/**
 * API Resource untuk Sertifikasi (single object).
 * Kolom tabel frontend: No, Judul (nama), Tanggal Dibuat, Komentar (alasan_penolakan), Status
 */
